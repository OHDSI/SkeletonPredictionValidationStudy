...
\NormalTok{devtools}\OperatorTok{::}\KeywordTok{install_github}\NormalTok{(}\StringTok{"OHDSI-studies/SkeletonPredictionValidationStudy"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(SkeletonPredictionValidationStudy)}
\NormalTok{?execute}
\end{Highlighting}
\end{Shaded}
